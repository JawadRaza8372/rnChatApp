  ...
  const manuitems = [
    {
      ...
      pressFunct: () =>
        Alert.alert(
          'Block Mark',
          'After This , you will not recive any messages from user.Are you sure?',
          [
            {
              text: 'Ok',
    ...
    },
    {
      ...
      pressFunct: () =>
        Alert.alert(
          'Report',
          'Report to admin,about this user.\nThis might cause user to be banned from this app parmanantly.',
          [
            {
              text: 'Ok',
              onPress: () => console.log('blocked'),
      ...
      <ImageBackground
        ...
        <KeyboardAvoidingView style={styles.msgCont}>
          <ChatInfoHead
            ...
            isMore={() => setmodalVisible(!modalVisible)}
          />
